      ...
      title: Column(
        ...
        children: [
          Text(ATexts.homeAppBarTitle, 
              style: Theme.of(context).textTheme.labelMedium?.apply(color: AColors.grey)),
          Text(currentUser?.fullName ?? 'Guest', // Provide fallback for null user
              style: Theme.of(context).textTheme.headlineSmall?.apply(color: AColors.white)),
        ],
      ),
      actions: [
