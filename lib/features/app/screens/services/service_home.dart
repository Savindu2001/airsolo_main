import 'package:airsolo/common/widgets/custome_shapes/containers/a_category_card.dart';
                ...
                child: ListView(
                  ...
                  children:  [
                    ...
                    AGridLayout(
                      ...
                      mainAxisExtent: 80,
                      itemBuilder: (_, index) {
                       return const ACategoryCard(image: AImages.guide, title: 'Guide', subTitle: '268 Guides',);
                      }
                      ),
